...
public class BillingSystem {
    public static final int ChairPrice= 30;
    public static final int TablePrice= 100;
            ...
            public void configure() throws Exception {
                ...
                .process(new Processor() {
                    ...
                    public void process(Exchange exchange) throws Exception {
                        ...
                        orderObject.setValid(customer.canBuy(orderObject.getNumberOfChairs()*ChairPrice + orderObject.getNumberOfTables()*TablePrice));
